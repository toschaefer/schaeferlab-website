...
Its main purpose is to find a unitary matrix which maximizes/minimizes an arbitrary cost function $L(U)$.
It can be used by providing the Eucledean derivative $\Gamma_{ij} = \partial L / \partial u^*_{ij}$ of the cost function.
